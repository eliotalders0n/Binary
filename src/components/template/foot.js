  ...
  return (
    ...
    >
      ...
      <p className="text-muted" style={{ fontSize: "1rem" }}>
        Join our student insurance community today and experience the peace of
        mind you deserve. Let us protect you on your educational journey.
      </p>
      <p>
        <b>Contact</b>+260 974 755027 | +260 974 755027 Emergency Line for
        members only: +260 (967 or 977) 521000 <b>Email</b> info@binary.org
        <br />
        <b>Address</b> Plot 283 Meanwood, Ndeke Village
      </p>
      <br />
      <p className="text-muted" style={{ fontSize: "12px" }}>
        We believe that your relationship with Jesus Christ is personal, and that God
      ...
      <Row className="d-flex justify-content-center">
        <Col md={4}>
          <h3>
            <span style={{ color: "purple" }}>Binary</span>
          </h3>
        </Col>
        <Col md={4}>
        ...
        <Col md={4}>
          <p className="text-muted">
            © 2023 <span style={{ color: "purple" }}>Binary</span>
          </p>
        </Col>
      </Row>
      <Row>
